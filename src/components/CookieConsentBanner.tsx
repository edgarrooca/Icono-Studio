...
export default function CookieConsentBanner() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[70] px-3 pb-3 sm:px-4 sm:pb-4 lg:px-6 lg:pb-6">
      <div className="pointer-events-auto mr-[5.25rem] w-auto rounded-[1.25rem] border border-white/8 bg-brand-dark/88 px-3.5 py-3 text-white shadow-[0_16px_40px_rgba(2,8,23,0.22)] backdrop-blur-xl sm:mx-auto sm:mr-0 sm:max-w-3xl sm:rounded-[1.35rem] sm:px-4 sm:py-3.5 lg:max-w-4xl lg:rounded-full lg:px-5 lg:py-3">
        <div className="flex flex-col gap-2.5 sm:gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center gap-3 pl-[3.25rem] sm:pl-0 lg:shrink-0">
            <button
              type="button"
