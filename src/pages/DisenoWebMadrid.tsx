...
export default function DisenoWebMadrid() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        redirectToLeadThankYouPage('contact_madrid_ads');
        return;
      } else {
    ...
    "@graph": [
      {
        ...
        "name": "Diseño Web Madrid | Icono Studio",
        "url": `${siteConfig.url}/diseno-web-madrid`,
        "description": "Servicio de diseño web en Madrid para negocios que necesitan una web rápida, cuidada y orientada a captar clientes.",
  ...
  return (
    <div className="valencia-page madrid-page min-h-screen bg-white font-sans text-brand-dark selection:bg-brand-lime selection:text-brand-dark overflow-x-hidden">
      <SeoHead
      ...
      <section id="vlc-hero" className="relative pt-32 pb-12 sm:pt-40 sm:pb-20 lg:pt-44 lg:pb-24 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center overflow-hidden bg-brand-dark text-white z-20 rounded-b-[2.5rem] md:rounded-b-[4rem] shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center text-center w-full max-w-5xl mx-auto">
          <h1 className="font-display text-[11vw] xs:text-5xl sm:text-6xl md:text-7xl leading-[0.95] tracking-tighter uppercase mb-6 sm:mb-8">
            <span className="block text-brand-lime text-[10px] sm:text-base md:text-lg font-black tracking-[0.4em] mb-3">DISEÑO WEB EN MADRID</span>
          ...
          <p className="text-base md:text-xl max-w-3xl text-white/70 font-medium mb-10 sm:mb-12 leading-relaxed">
            Diseñamos páginas web en Madrid rápidas, cuidadas y preparadas para que tu negocio transmita confianza, aparezca mejor en Google y reciba más contactos.
          </p>
      ...
      <section id="vlc-trust" className="relative z-30 -mt-6 md:-mt-10 px-4">
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 p-4 md:p-8 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-2">
          {[
            ...
            { label: "Desde Madrid", val: "Trato directo", icon: Heart },
          ...
          <div className="vlc-sectors-grid grid lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-[16px] md:text-[18px] text-gray-500 font-medium leading-relaxed mb-10 max-w-[420px]">
                Trabajamos desde Madrid con negocios de toda España, creando páginas web que transmiten confianza y ayudan a convertir visitas en contactos.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-16 gap-8 sm:gap-10">
            <div className="max-w-2xl shrink-0">
              ...
              <h2 className="font-display uppercase text-2xl md:text-4xl leading-[1.1] tracking-tight text-brand-dark mb-4">
                ...
                <span className="italic font-normal">diseño web Madrid</span>
              </h2>
            </div>
            <RouterLink 
              to="/proyectos" 
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <h2 className="font-display uppercase text-2xl md:text-4xl leading-[1.1] tracking-tight text-brand-dark mb-6">
            Diseño web en <br/> <span className="italic font-normal">todo Madrid</span>
          </h2>
          <p className="text-[15px] text-gray-500 font-medium leading-relaxed mb-10 max-w-2xl mx-auto">
            Trabajamos con negocios de Madrid y toda la comunidad, coordinando reuniones presenciales o gestión 100% online para asegurar un resultado perfecto.
          </p>
          <div className="flex flex-wrap justify-center gap-2 max-w-2xl mx-auto">
            {["Madrid", "Alcobendas", "Pozuelo", "Leganés", "Getafe", "Móstoles", "Alcalá de Henares", "Torrejón de Ardoz", "Las Rozas", "Majadahonda"].map((city) => (
              ...
              <div className="bg-white/5 border border-white/10 p-5 md:p-7 rounded-[2.5rem] backdrop-blur-md shadow-2xl relative">
                {isSubmitted ? (
                  ...
                  <form
                    ...
                    onSubmitCapture={() => debugLeadFormSubmitCapture('contact_madrid_ads')}
                    onInvalidCapture={(event) => {
                      const target = event.target as HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement;
                      debugLeadFormInvalid('contact_madrid_ads', target.name, target.validationMessage);
                    }}
                  ...
                  >
                    ...
                    <button 
                      type="submit" 
                      onClick={() => debugLeadFormButtonClick('contact_madrid_ads')}
