...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>textos que suenen profesionales y humanos</li>
      </ul>
  ...
  },
  {
    ...
    author: 'Icono Studio',
    tag: 'Desarrollo',
    image: 'https://picsum.photos/seed/blog2/800/800',
    metaTitle: 'Por qué tu web necesita ser más rápida | Icono Studio',
    metaDescription: 'La velocidad de carga es clave para el SEO y la conversión. Aprende por qué tu web debe volar.',
